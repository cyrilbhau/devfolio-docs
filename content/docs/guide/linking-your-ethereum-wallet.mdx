...
* [Through the Account Settings Page](settings.md)
* [While Cheering For a Project](onchain-features/crypto-cheer.md)
* [While Claiming Onchain Credentials](onchain-features/onchain-credentials.md) like Soul-bound Tokens (SBTs)
* [While Participating in Quadratic Voting](onchain-features/quadratic-voting-on-devfolio.md) for a Hackathon
* [While Claiming Hackathon Bounties](devfolio-for-hackers/participate/claims/)
